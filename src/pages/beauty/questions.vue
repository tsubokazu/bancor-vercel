<script setup lang="ts">
  ...
  import { BeautyQuestionsObject } from '~/types/pages/beauty/questions';
...
<template>
  <div class="flex w-full flex-col items-center overflow-hidden">
    ...
    <div class="relative flex w-full flex-col items-center">
      ...
      <!-- 枠 -->
      <div
        class="bg-color-white flex w-[95%] items-center justify-center rounded-[40px] px-[50px] py-[36px] pc:max-w-[1200px]"
      >
        <!-- よくあるご質問 -->
