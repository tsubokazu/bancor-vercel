export const usePagesDaycareStore = defineStore('pagesDaycare', () => {
  ...
  const fetchPagesDaycare = async () => {
    ...
    header.value = {
      ...
      imgUrl: '/images/daycare/header/daycare-header.png',
    };
      ...
      features: [
        {
          title: 'お子様の成長を\r\n支援する環境',
          outline:
            '自由な発想を尊重し、のびのびとした成長環境を用意しています。',
          imgUrl: '/images/daycare/features/01.png',
        },
        {
          title: '職歴豊富な\r\n指導員の充実',
          outline: 'お子様ひとりひとりに合わせた、特別な指導を心がけています。',
          imgUrl: '/images/daycare/features/02.png',
        },
        {
          title: '成長に最適な\r\nカリキュラム',
          outline: 'お子様の成長に最適なカリキュラムをご提案いたします。',
          imgUrl: '/images/daycare/features/03.png',
        },
      ],
    };
    ...
    // 教育方針
    policy.value = {
      title: '星ノ学園が掲げる3つの教育方針',
      outline:
        '八幡西区の児童発達支援事業所星ノ学園では、子供たちから沢山の笑顔が生まれるような場所を提供し、のびのびと楽しく過ごす中で、子どもたちの成長のお手伝いをしています',
      policies: [
        {
          title: '心のケア',
          outline:
            '自分の気持ちを伝えることが苦手なお子さまや、お友達とのコミュニケーションが苦手なお子さま一人ひとりの気持ちや主張を尊重しサポートします',
          imgUrl: '/images/daycare/policy/care.png',
        },
        {
          title: '楽しむ',
          outline:
            '温かい雰囲気の中で、楽しいことや嬉しいことなど自分の力を表現する力を育み、お子さまが心から「楽しい！」と思える環境づくりを心がけています',
          imgUrl: '/images/daycare/policy/fun.png',
        },
        {
          title: '自立の力',
          outline:
            '日々の生活の中で、身の回りのことが「自分で出来るようサポート」し、また集団生活の中でお友達と協力することや、社会ルール・マナーの理解を支援します。',
          imgUrl: '/images/daycare/policy/independence.png',
        },
      ],
      staffs: [
        {
          name: '児童発達支援管理責任者（常勤）',
          number: '4名',
          imgUrl: '/images/daycare/policy/01.png',
        },
        {
          name: '保育士（常勤）',
          number: '4名',
          imgUrl: '/images/daycare/policy/02.png',
        },
        {
          name: '保育士（非常勤）',
          number: '2名',
          imgUrl: '/images/daycare/policy/03.png',
        },
        {
          name: '児童指導員（常勤）',
          number: '9名',
          imgUrl: '/images/daycare/policy/04.png',
        },
        {
          name: '児童指導員（非常勤）',
          number: '1名',
          imgUrl: '/images/daycare/policy/05.png',
        },
        {
          name: 'その他従業者（常勤）',
          number: '2名',
          imgUrl: '/images/daycare/policy/06.png',
        },
        {
          name: 'その他従業者（非常勤）',
          number: '1名',
          imgUrl: '/images/daycare/policy/07.png',
        },
      ],
      imgUrl: '/images/daycare/policy/08.png',
    };
    ...
    environment.value = {
      ...
      environments: [
        {
          imgUrl: '/images/daycare/environment/01.png',
        },
        {
          imgUrl: '/images/daycare/environment/02.png',
        },
        {
          imgUrl: '/images/daycare/environment/03.png',
        },
        {
          imgUrl: '/images/daycare/environment/04.png',
        },
        {
          imgUrl: '/images/daycare/environment/05.png',
        },
        {
          imgUrl: '/images/daycare/environment/06.png',
        },
      ],
      tag: '放課後デイサービス',
      linkTitle: '星ノ学園園内環境',
    ...
    guideline.value = {
      ...
      imgUrl: '/images/daycare/guideline/00.png',
      guideline: {
        title: '施設ご利用までの流れ',
        outline:
        ...
        step01: {
          ...
          imgUrl: '/images/daycare/guideline/01-kengaku.png',
          numberImgUrl: '/images/daycare/guideline/01.png',
          tel: '093-883-7020',
        },
        step02: {
          title: '受給者証の申請',
          ...
          imgUrl: '/images/daycare/guideline/02-shinsei.png',
          numberImgUrl: '/images/daycare/guideline/02.png',
        },
        step03: {
          title: '個別支援計画の作成',
          outline: '利用計画書(セルフプラン)と必要書類を準備します。',
          imgUrl: '/images/daycare/guideline/03-plan.png',
          numberImgUrl: '/images/daycare/guideline/03.png',
          subSteps: [
            {
        ...
        step04: {
          ...
          imgUrl: '/images/daycare/guideline/04-contract.png',
          numberImgUrl: '/images/daycare/guideline/04.png',
        },
        step05: {
          title: 'サービスの開始',
          imgUrl: '/images/daycare/guideline/05-start.png',
          numberImgUrl: '/images/daycare/guideline/05.png',
          subSteps: [
            {
    ...
    contact.value = {
      ...
      telOnImgUrl: '/images/daycare/contact/tel-on.png',
      telOffImgUrl: '/images/daycare/contact/tel-off.png',
      tel: '093-883-7020',
      mailOnImgUrl: '/images/daycare/contact/mail-on.png',
      mailOffImgUrl: '/images/daycare/contact/mail-off.png',
    ...
    information.value = {
      ...
      imgUrl: '/images/daycare/information/01.png',
    };
    ...
    questions.value = {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            'はい、送迎の兼ね合いから基本的に「小倉、戸畑地域」を中心に運用しております。その他のエリアにつきましては、直接お電話(090-883-7020)にてご相談ください。\r\n※ 小倉、戸畑地域でも、時間帯やお住いの場所によっては送迎が困難となる場合もございます。予めご了承ください。',
        },
        {
    ...
    fee.value = {
      ...
      dayservice: {
        overview: {
          ...
          imgUrl: '/images/daycare/fee/overview.png',
      ...
      support: {
        overview: {
          title: '児童発達支援とは',
          outline:
            '児童発達支援とは、障がい児通所支援の一つです。\r\n小学校就学前の6歳までの障害のある子どもが主に通い、障害のあるお子さまへの発達支援やそのご家族への支援を中心に、日常生活における基本動作や知識技術を習得するためのサポートを行います\r\n児童発達支援は大きく分けて「児童発達支援センター」と「児童発達支援事業所」の2種類に分かれており、幼稚園などへの入園や小学校への入学に向けた「集団生活への適応訓練」などの支援も行っております。',
          imgUrl: '/images/daycare/fee/support.png',
          center: '児童発達支援センターとは',
          centerOutline:
          ...
          facilityOutline:
            '児童発達支援事業所は、0歳〜小学校入学前までの、まだ就学していないお子様たちが、自分の慣れ親しんだ地域での発達支援を提供している施設です。\r\n障がいを持ったお子さまの中でも「発達障害のお子さま」「難病にかかっているお子さま」「心身に障害を持ったお子さま」を対象に支援を行い、課題を解決するお手伝いをしたり、そのご家族への支援を行うことで、お子さまとその周りの負担を軽減することを主な目的としています。',
        },
        fee: {
          title: 'ご利用料金目安表 月額（上限）',
          fee1: '0円',
