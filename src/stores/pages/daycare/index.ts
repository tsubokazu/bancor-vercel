export const usePagesDaycareStore = defineStore('pagesDaycare', () => {
  ...
  const fetchPagesDaycare = async () => {
    ...
    topics.value = {
      title: 'Topics',
      topics: journalList.slice(0, 3).map((journal: any) => ({
        title: journal.subject,
        tag: journal.hashTag[0],
        date: journal.updateDate,
        linkUrl: `/journal/${journal.topicsId}`,
    ...
    //       tag: '放課後デイサービス',
    //       date: '2023.05.20',
    //       linkUrl: 'https://bancor.co.jp/journal/100',
    //     },
    //     {
    //       title: '星ノ学園ユニプレキッズとは？',
    //       tag: '放課後デイサービス',
    //       date: '2023.05.12',
    //       linkUrl: 'https://bancor.co.jp/journal/101',
    //     },
    //     {
    //       title: '星ノ学園ユニプレキッズの療育内容',
    //       tag: '放課後デイサービス',
    //       date: '2023.04.01',
    //       linkUrl: 'https://bancor.co.jp/journal/102',
    //     },
    //   ],
    // };
    ...
    features.value = {
      title:
        'お子様だけでなくご家族含めた温かい未来づくりを指導員一同丁寧にご支援します。',
      features: [
        {
          title: '職歴豊富な\r\n指導員の充実',
    ...
    environment.value = {
      ...
      environmentOutline: '八幡西区で運営する星ノ学園ユニプレキッズ施設内写真',
      environments: [
        {
    ...
    // 星ノ学園ユニプレキッズご利用ガイドライン
    guideline.value = {
      title: '星ノ学園ユニプレキッズ\r\nご利用ガイドライン',
      outline:
        '事業所での1日の過ごし方やご利用に関する流れを知ることができます。',
      ...
      notice:
        '※各事業所によって時間帯が異なる場合がありますのでお問合せくださいませ。',
    };
    ...
    questions.value = {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            'はい、送迎の兼ね合いから基本的に「八幡西区」を中心に運用をしております。\r\nその他のエリアにつきましては、直接お電話（093-883-7020）にてご相談ください。\r\n※ 八幡西区地域でも、時間帯やお住まいの場所によっては送迎が困難となる場合もございます。予めご了承ください。',
        },
        {
          question: '利用を断られる場合はありますか？',
          answer:
            '医療的なケアが必要なお子さまにつきましては、専門的なスタッフの配置状況などによりご利用をお断りさせて頂く場合がございます。\r\nまた、過度な自傷行為、他のご利用者様への他害行為などが頻繁にあるお子さまにつきましては、ご利用をお断りさせていただくケースもございます。\r\n詳しくは、直接お電話(093-883-7020)にてご相談ください。',
        },
        {
          question:
            '土曜、日曜、祝日、長期休暇などでも利用することはできますか？',
          answer:
            '土曜日、長期休暇はご利用いただけます。\r\n日曜日、祝日は各施設お休みとなります。',
        },
        {
